...
export type Flow = { rawKg: number; dryMatterKg: number; finalKg: number; waterKg: number;
...
export type ReportSnapshot = {clientName?: string; calculationId?: string; createdAt?: string; input: EngineeringInput; result: EngineeringResult; modelName: string; cropName: string; fuelName: string; fuelUnit: string; missing: string[]; warnings: string[]};
