...
export function Technology({en}:{en:boolean}){
 ...
 <Dialog open={open} onOpenChange={setOpen}><DialogContent className="arqon-dialog flow-dialog" showCloseButton={false} aria-describedby={undefined}><DialogClose className="modal-close" aria-label={t('Закрити схему','Close diagram')}/><DialogTitle>{t('SAHARA · Схема потоків','SAHARA · Flow diagram')}</DialogTitle><Image src={asset('/images/sahara-flow-v2.webp')} alt={alt} width={1536} height={864}/>{legend}</DialogContent></Dialog>
 </section>;
}
