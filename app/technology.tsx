...
export function Technology({en}:{en:boolean}){
 ...
 <details className="dryer-description"><summary><span>{t('Докладніше про сушарку','More about the dryer')}</span><span className="dryer-description-toggle" aria-hidden="true">+</span></summary><div className="dryer-description-content">
